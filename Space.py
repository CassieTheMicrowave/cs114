...
'attack': 50,
'defense': 50,
'name': 'Pack of zombie mutated cats'
}
...
def get_weapon(opponent):
    weapon_list = ["Pocket Knife", "Broomstick", "Wire"]

    print("You find a ", weapon_list[random.randint(0, 2)], "your base attack damage went up")
    rand_damage = random.randint(12, 38)
...
def attack(player, opponent):
    ...
    total_damage = player[attack]/100 
    opponent['HP'] -= rand_damage
    print(rand_damage, " damage!")
    return opponent
